...
const PRODUCTLIST = () =>{
    ...
    const ItemsData = async()=>{
        ...
        const result = await axios.get(`http://127.0.0.1:7070/api/v2/products/getAllProducts`,{  
        })
    ...
    if (items.data) {
    console.log("CATEGORIES",items.data.result);
    ...
    return(
        <div className="cat-container">
            ...
            <thead>
                ...
                <tbody>
                    { items.data.result.map((ItemsDetail, index)=>{
